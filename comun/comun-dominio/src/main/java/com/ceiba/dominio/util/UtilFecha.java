...
public class UtilFecha {
    ...
    public static Integer validarFinDeSemanaEntreFechas(LocalDateTime fechaInicial, LocalDateTime fechaSalida) {

        Long diferenciaDeDias = calcularDiasNetos(fechaInicial, fechaSalida);
